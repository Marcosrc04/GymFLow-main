...
if (
    !isset($_SESSION["id"]) ||
    !in_array($_SESSION["tipo"], ["admin", "aluno"])
) {
    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            ...
            <?php if ($isAdmin): ?>
                ...
                <a href="/GymFlow-main/paginas/admin/dashboard-admin.php">
                    <span class="icon">📊</span> Dashboard
                </a>

                <a href="/GymFlow-main/paginas/admin/alunos.php">
                    <span class="icon">👥</span> Alunos
                </a>

                <a href="/GymFlow-main/paginas/admin/pagamentos.php">
                    <span class="icon">💳</span> Mensalidades
                </a>
                ...
                <a href="/GymFlow-main/paginas/aluno/perfil.php" class="ativo">
            ...
            <?php else: ?>
                ...
                <a href="/GymFlow-main/paginas/aluno/dashboard-aluno.php">
                    <span class="icon">📊</span> Dashboard
                </a>

                <a href="/GymFlow-main/paginas/aluno/gerar_treino_com_ia/gerar-treino.php">
                    <span class="icon">🏋️</span> Meus Treinos
                </a>

                <a href="/GymFlow-main/paginas/aluno/caixa.php">
                    <span class="icon">💳</span> Mensalidades
                </a>
            ...
            <a href="/GymFlow-main/logout.php">
