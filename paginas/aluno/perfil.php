                ...
                <div class="perfil-card-id">
                    <div class="perfil-avatar-wrap">
                        <?php if (!empty($usuario["foto"])): ?>
                            <div class="perfil-avatar"><img src="../../arquivos/imagem/perfis/<?php echo htmlspecialchars($usuario["foto"]); ?>" alt="Foto de perfil"></div>
                        <?php else: ?>
